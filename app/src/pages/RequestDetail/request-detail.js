...
export const RequestDetail = (props) => {
	...
	// const filterRequest = requests.filter(request => request.requestId === match.params.requestId);
	// const request = {...filterRequest};

	// console.log(request)

	// let weHaveData = (!(Object.entries(request).length === 0 && request.constructor === Object));
